...
func (o *DisableUserOK) Error() string {
	return fmt.Sprintf("[PUT /api/users/{id}/disable][%d] disableUserOK  %+v", 200, o.Payload)
}
...
func (o *DisableUserDefault) Error() string {
	return fmt.Sprintf("[PUT /api/users/{id}/disable][%d] DisableUser default  %+v", o._statusCode, o.Payload)
}
