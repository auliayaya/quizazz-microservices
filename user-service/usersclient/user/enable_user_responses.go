...
func (o *EnableUserOK) Error() string {
	return fmt.Sprintf("[PUT /api/users/{id}/enable][%d] enableUserOK  %+v", 200, o.Payload)
}
...
func (o *EnableUserDefault) Error() string {
	return fmt.Sprintf("[PUT /api/users/{id}/enable][%d] enableUser default  %+v", o._statusCode, o.Payload)
}
